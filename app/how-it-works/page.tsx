const faq = [
  {
    ...
    a: "You can sell back into the curve at any time before graduation — the same constant-product formula prices you out as it priced you in, minus fees. There's no lockup on the buy side.",
  },
  {
    q: "Can the Parabola team take the money in a curve?",
    a: "No. The owner account can change the platform-wide fee rate (capped at 5%), the treasury address fees are sent to, and which DEX router new graduations use — and can pause new launches. It has no function that can withdraw, freeze, or redirect a single curve's raised funds or tokens. Read BondingCurve.sol and LaunchFactory.sol yourself — every owner-only function is listed together at the bottom of LaunchFactory.sol.",
  },
  {
    q: "What stops the creator from dumping their whole allocation immediately?",
    a: "On a meme launch, there is no team allocation — the creator buys on the open curve exactly like anyone else. On a builder launch, the team's tokens sit in an OpenZeppelin VestingWallet that releases linearly over the schedule fixed at creation (minimum 90 days) — nobody, including the creator, can accelerate it.",
  },
  {
    ...
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <div className="mt-10 space-y-10">
        ...
        <section>
          ...
          <p className="mt-2 leading-relaxed text-paper-dim">
            Once a curve raises enough real USDC, it graduates: the contract itself — not a person, not an admin
        ...
        <section id="security">
          ...
          <p className="mt-2 leading-relaxed text-paper-dim">
            ...
            itself, automatically, in the same call — and if that automatic attempt can&apos;t complete (for example, the
